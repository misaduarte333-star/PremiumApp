...
import type { Barbero, Profesional, Sucursal, DiasSemana } from '@/lib/types'
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            ...
            <div className="bg-slate-900 rounded-2xl shadow-2xl border border-slate-800 w-full max-w-6xl max-h-[90vh] flex flex-col">
                ...
                <div className="p-6 border-b border-slate-800 flex items-center justify-between">
                    <div>
                        <h2 className="text-2xl font-bold text-white">Horarios del {labels.businessName}</h2>
                ...
                <div className="flex-1 overflow-auto p-6">
                    <div className="min-w-[800px]">
                        ...
                        <div className="grid grid-cols-[200px_1fr] mb-4">
                            <div className="text-slate-500 text-xs uppercase font-bold tracking-wider pt-2">{labels.professional} / Hora</div>
                        ...
                        <div className="space-y-4">
                            {profesionales.map(profesional => {
                                ...
                                return (
                                    <div key={profesional.id} className="grid grid-cols-[200px_1fr] group hover:bg-slate-800/20 rounded-lg transition-colors">
                                        <div className="flex items-center gap-3 py-2 pr-4 pl-2">
                                            ...
                                            <div>
                                                <p className="font-medium text-slate-200 text-sm">{profesional.nombre}</p>
                                                                                                <p className="text-[10px] text-slate-500">{labels.location} {profesional.estacion_id}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid relative items-center" style={{ gridTemplateColumns: `repeat(${hours.length}, 1fr)` }}>
                                            ...
                                            {hours.map(hour => {
                                                ...
                                                // Check for lunch
                                                let isLunch = false
                                                if (profesional.bloqueo_almuerzo && profesional.bloqueo_almuerzo.inicio && profesional.bloqueo_almuerzo.fin) {
                ...
                <div className="p-4 border-t border-slate-800 flex gap-6 text-xs text-slate-400">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span>Turno {labels.professional}</span>
                    </div>
                    <div className="flex items-center gap-2">
